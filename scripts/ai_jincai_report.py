...
20. 必须加入“世界杯/国家队冷门观察”独立分支：仅适用于世界杯、世预赛、洲际杯、国家队友谊赛等国家队场景。赔率、亚盘、凯利、大小球和跨窗口变化是主线；大名单、伤停、停赛、预计首发、长途旅行、战意和轮换只作为确认、降级或推翻条件，不得用基本面故事单独升绿，也不得因为没有首发就机械压低所有国家队场次。
...
22. 世界杯/国家队场景不得直接套用五大联赛冷门率。强队深让、名气过热、战意不透明、轮换未知时最多升观察绿；如果赔率结构、盘口水位、大小球/凯利/跨源欧赔至少两类同向，且没有确认伤停或战意反向，可以不等首发进入执行绿候选。
23. 必须使用“结构化赔率方向摘要”辅助判断跨窗口共振：亚盘让球、亚洲大小球、竞彩让球指数和欧赔分开看。只有一个快照时只能写基线；两个以上快照才写变化。无法解析的 raw_only 行只能作为数据证据，不能补造方向。
...
11. 复盘必须检查结构化赔率方向摘要是否支持赛前判断：亚盘、亚洲大小球、竞彩让球指数、欧赔分开验收，无法解析的 raw_only 行只记录为数据质量问题。
