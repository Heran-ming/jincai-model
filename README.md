...
- 执行绿灯不强制等待确认首发。首发不可见只作为不确定性惩罚和推翻条件；执行绿仍需赔率方向、盘口支撑和至少一类可靠外部确认，例如亚盘、大小球、凯利、跨源欧赔、伤停、战意或历史相似盘口有效样本。

## 可进入预测的盘口市场

- 全场让球、全场大小球、半场让球、半场大小球都可以进入预测观察池。
- 四类市场必须分开锁版，分别记录来源、盘口、赔率/水位、命中条件、三分、最大反方证据和推翻条件。
- 半场盘口只验上半场比分，全场盘口只验 90 分钟常规时间比分；复盘时分市场统计命中率和 1u 模拟收益。
